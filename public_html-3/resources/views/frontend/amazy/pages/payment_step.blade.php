            ...
            $(document).ready(function() {
                $(document).on('change', 'input[type=radio][name=payment_method]', function(){
                    ...
                    if(method === 'Stripe'){
                        ...
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="CCAvenue" class="amaz_primary_btn style2  min_200 text-center text-uppercase">Pay now</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }
