...
@section('content')
                ...
                @foreach ($commissions->where('status', 1) as $key => $commission)
                    <div class="{{$column}}">
                        <div class="single_pricing_part @if ($commission->id == 1) product_tricker @endif">
                            ...
                            <a href="{{ route('frontend.merchant-register', base64_encode($commission->id)) }}"
    ...
    <section class="send_query"><!--class="send_query section_padding"-->
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-6">
                    <div class="section_tittle">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-xl-8">
                    <form action="#" id="contactForm" name="#" class="send_query_form" style="padding-top:0px">
                        <div class="row">
                            <div class="col-xl-12">
