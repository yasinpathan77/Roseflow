...
@php
    $headers = \Modules\Appearance\Entities\Header::all();
@endphp
<x-slider-2-component :headers="$headers" id="5"/>
<br><br>
<!-- home_banner 2 ::end  -->
...
@php
    $headers = \Modules\Appearance\Entities\Header::all();
@endphp
<x-slider-2-component :headers="$headers" id="6"/>
<!-- home_banner 2 ::end  -->
...
@php
    $headers = \Modules\Appearance\Entities\Header::all();
@endphp
<x-slider-2-component :headers="$headers" id="7"/>
<br><br>
<!-- home_banner 2 ::end  -->

<!-- cta::start  -->
<div id="cta_banner_section" class="amaz_section">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
...
@php
    $headers = \Modules\Appearance\Entities\Header::all();
@endphp
<x-slider-2-component :headers="$headers" id="8"/>
<!-- home_banner 2 ::end  -->
...
@endphp
<div id="amzcart_tabs_section" class="amaz_section section_spacing3">
    <div class="container">
        <div class="row">
            <div class="col-12">
...
@php
    $headers = \Modules\Appearance\Entities\Header::all();
@endphp
<x-slider-2-component :headers="$headers" id="9"/>
<br><br>
<!-- home_banner 2 ::end  -->
...
@php
    $headers = \Modules\Appearance\Entities\Header::all();
@endphp
<x-slider-2-component :headers="$headers" id="10"/>
<br>
<!-- home_banner 2 ::end  -->
...
@endphp
<div id="amaz_recomanded_area" class="amaz_recomanded_area {{$more_products->status == 0?'d-none':''}}">
    <div class="container">
        <div class="row">
            <div class="col-12">
...
@php
    $headers = \Modules\Appearance\Entities\Header::all();
@endphp
<x-slider-2-component :headers="$headers" id="11"/>
<br>
<!-- home_banner 2 ::end  -->
