...
use Modules\PaymentGateway\Http\Controllers\CCAvenueController;
...
class OrderController extends Controller
{
    ...
    public function payment(Request $request)
    {
        ...
        elseif ($request->method == "MercadoPago") {
            ...
            $data = $ccavenueController->payment($request->all());
            return view('paymentgateway::ccavenue.index', $data);//home4/pandaowy/roseflo.com/Modules/PaymentGateway/Resources/views/ccavenue/index.blade.php
        }else{
            return redirect()->back();
        }
