...
class MerchantRegisterController extends Controller
{
    ...
    protected function create($data)
    {
        ...
        //Modify at 2023-05-17
        //When merchant register after OTP authentication not redirecting in seller dashboard
        //if($data->has('custom_field')){
        if(isset($data['custom_field']) && $data->has('custom_field')){
