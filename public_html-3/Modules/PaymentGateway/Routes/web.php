...
Route::post('ccavenue-cancel', 'CCAvenueController@failed')->name('ccavenue.ccavenueFailed');
Route::post('ccavenue-payment/success', 'CCAvenueController@success')->name('ccavenue.ccavenueSuccess');
