        ...
        <div class=" float-none pos_tab_btn justify-content-start">
            ...
            <ul class="nav nav_list" role="tablist">
                @foreach(@$gateway_activations as $gateway)
                    ...
                    @elseif($gateway->method->method == 'CCAvenue' && @$gateway->status == 1)
                        <li class="nav-item mb-2">
                            <a class="nav-link @if($key == 0) active show @endif" href="#ccavenueTab" role="tab"
                                data-toggle="tab" id="1" aria-selected="true">{{__('payment_gatways.ccavenue')}}</a>
                        </li>
                    @endif
                    @php
                        $key ++;
    ...
    <div class="white_box_30px mb_30">
        <div class="tab-content">
            ...
            @foreach(@$gateway_activations as $gateway)
                ...
                @elseif($gateway->method->method == 'CCAvenue' && @$gateway->status == 1)
                    <div role="tabpanel" class="tab-pane fade @if($key == 0) active show @endif" id="ccavenueTab">
                        <div class="box_header common_table_header ">
                            <div class="main-title d-md-flex">
                        ...
                        @include('paymentgateway::components.ccavenue_config')
                    </div>
                @endif
                @php
                    $key ++;
