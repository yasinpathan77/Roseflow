<div class="box_header common_table_header">
    <div class="main-title d-md-flex">
        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('common.edit') }}</h3>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="primary_input mb-25">
                    ...
                    <textarea class="primary_textarea height_112 description" placeholder="{{ __('common.description') }}" name="description" spellcheck="false"></textarea>
