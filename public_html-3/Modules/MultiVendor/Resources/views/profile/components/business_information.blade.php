        ...
        <div class="white-box">
            <div class="add-visitor">
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="primary_input mb-25">
                            ...
                            <input name="business_postcode" class="primary_input_field" placeholder="-" type="text"
                                   value="{{ old('business_postcode')? old('business_postcode'):$seller->SellerBusinessInformation->business_postcode }}">
                    ...
                    <div class="col-xl-6">
                        <div class="primary_input mb-25">
                            <label class="primary_input_label" for="business_registration_number">{{__('seller.pan_number')}}</label>
                            <input name="business_registration_number" class="primary_input_field" placeholder="-" type="text"
                                   value="{{ old('business_registration_number')? old('business_registration_number'): $seller->SellerBusinessInformation->business_registration_number}}">
                    ...
                    <div class="col-xl-6">
                        <div class="primary_input mb-25">
                            <label class="primary_input_label" for="seller_tin">{{__('seller.gst_number')}}</label>
