            ...
            <div class="white-box">
                <div class="add-visitor">
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                <label class="primary_input_label" for="routing_number">{{__('common.ifsc')}} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                <label class="primary_input_label" for="ibn">{{__('common.pan_number')}} <span class="text-danger">*</span></label>
