            ...
            <div class="col-lg-4 col-md-4 col-sm-12 mb_10">
                <div class="main-title d-flex">
                    ...
                    <ul class="d-flex">
                        ...
                        <li><a href="{{route('frontend.seller',getParentSeller()->slug)}}" target="_blank"
                                class="primary-btn radius_30px mr-10 fix-gr-bg">{{ __('dashboard.shop_link') }}</a></li>
                        @else
                        <li><a href="{{route('frontend.seller',base64_encode(getParentSellerId()))}}"target="_blank"
                            class="primary-btn radius_30px mr-10 fix-gr-bg">{{ __('dashboard.shop_link') }}</a></li>
                        @endif
                        @if(@$sellerAccount->seller_commission_id == 3)
                            @php
                ...
                <div
                    ...
                    <a @if (Auth::user()->role->type == "seller")
                        ...
                        <div class="d-block mt-10">
                            ...
                            <h1 class="gradient-color2 total_products">{{ $total_products }}</h1>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div
                    ...
                    <a @if (Auth::user()->role->type == "seller" && isModuleActive('MultiVendor'))
                        ...
                        <div class="d-block mt-10">
                            ...
                            <img class="demo_wait d-none" height="60px"
                                src="{{showImage('backend/img/loader.gif')}}" alt="">
                            <h1 class="gradient-color2 total_orders">{{ $total_orders }}</h1>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div
                    ...
                    <a @if (Auth::user()->role->type == "seller" && isModuleActive('MultiVendor'))
                        ...
                        <div class="d-block mt-10">
                            ...
                            <img class="demo_wait d-none" height="60px"
                                src="{{showImage('backend/img/loader.gif')}}" alt="">
                            <h1 class="gradient-color2 total_delivered_order">{{ $total_delivered_orders }}</h1>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div
                    ...
                    <a @if (Auth::user()->role->type == "seller")
                        ...
                        <div class="d-block mt-10">
                            ...
                            <img class="demo_wait d-none" height="60px"
                                src="{{showImage('backend/img/loader.gif')}}" alt="">
                            <h1 class="gradient-color2 total_not_delivered_orders">{{ $total_not_delivered_orders }}
                            </h1>
                        </div>
                    </a>
                </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                <div
                    ...
                    <div class="d-block mt-10">
                        ...
                        <img class="demo_wait d-none" height="60px"
                            src="{{showImage('backend/img/loader.gif')}}" alt="">
                        <h1 class="gradient-color2 shop_review">{{ $shop_review }}</h1>
                    </div>
                </div>
            </div>
            @endif
                            ...
                            <div class="">
                                <table class="table Crm_table_active4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="nowrap">
                                                {{ date(app('general_setting')->dateFormat->format, strtotime($latest_order->order->created_at)) }}
                                            </td>
                                            <td>{{ @$latest_order->order->order_number }}</td>
                                            <td>
                            ...
                            <div class="">
                                <table class="table Crm_table_active4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="nowrap">
                                                {{ date(app('general_setting')->dateFormat->format, strtotime($latest_refund->created_at)) }}
                                            </td>
                                            <td>{{ @$latest_refund->order->order_number }}</td>
                                            <td>
                            ...
                            <div class="">
                                <table class="table Crm_table_active4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="nowrap">
                                                {{ date(app('general_setting')->dateFormat->format, strtotime($payment->created_at)) }}
                                            </td>
