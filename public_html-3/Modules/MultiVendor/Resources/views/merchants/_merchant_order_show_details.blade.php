                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <table class="table-borderless clone_line_table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>: {{ @$order_package->address->billing_phone }}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>: {{ @$order_package->address->billing_postcode }}</td>
                                                </tr>
                                            </table>
                                        </div>
                                    @else
                                        <div class="col-md-6 col-lg-6">
                                            <table class="table-borderless clone_line_table">
                                                ...
                                                <tr>
                                                    <td>{{__('common.phone')}}</td>
                                                    <td>: {{$order_package->guest_info->billing_phone}}</td>
                                                </tr>
                                                <tr>
                                                    <td>{{__('common.address')}}</td>
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        @if ($order_package->customer_id)
                                            <table class="table-borderless clone_line_table">
                                                ...
                                                <tr>
                                                    <td>{{__('common.phone')}}</td>
                                                    <td>: {{ @$order_package->address->shipping_phone }}</td>
                                                </tr>
                                                <tr>
                                                    <td>{{__('common.address')}}</td>
                                                ...
                                                <tr>
                                                    <td>{{__('common.postcode')}}</td>
                                                    <td>: {{ @$order_package->address->shipping_postcode }}</td>
                                                </tr>
                                            </table>
                                        @else
                                            <table class="table-borderless clone_line_table">
                                                ...
                                                <tr>
                                                    <td>{{__('common.phone')}}</td>
                                                    <td>: {{$order_package->guest_info->shipping_phone}}</td>
                                                </tr>
                                                <tr>
                                                    <td>{{__('common.address')}}</td>
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <table class="table-borderless clone_line_table">
                                            ...
                                            <tr>
                                                ...
                                                <td>:
                                                    {{ date(app('general_setting')->dateFormat->format, strtotime(@$order_package->order_payment->created_at)) }}
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    @if(isModuleActive('Affiliate'))
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <table class="table-borderless clone_line_table">
                                                ...
                                                <tr>
                                                    <td>{{__('common.phone')}}</td>
                                                    <td>: {{ @$order_package->affiliateUser->user->phone }}</td>
                                                </tr>
                                            </table>
                                        </div>
                                        @endif
                                        ...
                                        <div class="col-12 mt-30">
                                            ...
                                            <div class="box_header common_table_header justify-content-lg-end">
                                                {{-- @if (file_exists(base_path().'/Modules/GST/') && (app('gst_config')['enable_gst'] == "gst" || app('gst_config')['enable_gst'] == "flat_tax"))
                                                    <div>
                                                        @foreach ($order_package_package->gst_taxes as $key => $gst_tax)
                                                            <h5>{{ $gst_tax->gst->name }} : {{ single_price($gst_tax->amount) }}</h5>
                                                        @endforeach
                                                    </div>
                                                @endif --}}
                                                <ul class="d-flex float-right">
                                                    <li> <strong>Shipping Method : {{ $order_package_package->shipping->method_name }}</strong></li>
                                                </ul>
                                            </div>
                                                                    ...
                                                                    <td>
                                                                        @if ($package_product->type == "gift_card")
                                                                            ...
                                                                            <a class="green gift_card_div pointer" data-gift-card-id='{{ $package_product->giftCard->id }}' data-qty='{{ $package_product->qty }}' data-customer-mail='{{($order_package->customer_id) ? $order_package->customer_email : $order_package->guest_info->shipping_email}}' data-order-id='{{ $order_package->id }}'>
                                                                                ...
                                                                                {{($order_package->gift_card_uses->where('gift_card_id', $package_product->giftCard->id)->first() != null && $order_package->gift_card_uses->where('gift_card_id', $package_product->giftCard->id)->first()->is_mail_sent) ? "Sent Already" : "Send Code Now"}}
                                                                            </a>
                                                                        @else
