                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <table class="table table-borderless customer_view">
                                    <tr>
                                        <td class="first_row_width">{{ __('common.phone') }}</td>
                                        <td>: <span class="ml-1"></span>{{ @$user->SellerAccount->seller_phone }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    @elseif (@$user->SellerAccount->holiday_type == 2)
                                        <tr>
                                            ...
                                            <td>: <span class="ml-1"></span>{{ @$user->SellerAccount->holiday_date_start }} to {{ @$user->SellerAccount->holiday_date_end }}</td>
                                        </tr>
                                    @else
                                        <tr>
                                            <td class="first_row_width">{{ __('common.holiday_duration') }}</td>
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <table class="table table-borderless customer_view">
                                    ...
                                    <tr>
                                        ...
                                        <td>: <span class="ml-1"></span>{{ @$user->SellerBankAccount->bank_account_number }}</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <table class="table table-borderless customer_view">
                                    ...
                                    <tr>
                                        <td class="first_row_width">{{ __('common.postcode') }}</td>
                                        <td>: <span class="ml-1"></span>{{ @$user->SellerWarehouseAddress->warehouse_postcode }}</td>
                                    </tr>
                                    <tr>
                                        <td class="first_row_width">{{ __('common.phone') }}</td>
                                        <td>: <span class="ml-1"></span>{{ @$user->SellerWarehouseAddress->warehouse_phone }}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                ...
                                @else
                                    <table class="table table-borderless customer_view">
                                        ...
                                        <tr>
                                            <td class="first_row_width">{{ __('common.postcode') }}</td>
                                            <td>: <span class="ml-1"></span>{{ @$user->SellerReturnAddress->return_postcode }}</td>
                                        </tr>
                                        <tr>
                                            <td class="first_row_width">{{ __('common.phone') }}</td>
                                            <td>: <span class="ml-1"></span>{{ @$user->SellerReturnAddress->return_phone }}</td>
                                        </tr>
                                    </table>
                                @endif
                            </div>
                    ...
                    <div class="white_box_50px box_shadow_white">
                        <div class="col-lg-12 student-details">
                            <ul class="nav nav-tabs tab_column mb-50" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#OrderRepand" role="tab" data-toggle="tab">{{ __('common.order_repand') }}</a>
                                </li>
                            </ul>
