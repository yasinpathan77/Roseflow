...
class Header extends Model
{
    ...
    public function sliderSectionItems_2($id){
        
        return HeaderSliderPanel2::where("headers_id", $id)->orderBy('position')->get();
    }
    ...
    public function sliders_2($headers_id){
        
        return HeaderSliderPanel2::with(['category'])->where("headers_id", $headers_id)->where('status', 1)->orderBy('position')->get();
    }
