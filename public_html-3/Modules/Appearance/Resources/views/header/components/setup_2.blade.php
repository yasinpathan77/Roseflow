                    ...
                    <div class="col-lg-8">
                        <div class="iframe_div">
                            @php
                                $show_section = "";
                                if($header->id == 5){
                                    $show_section = "#best_deals";
                                }elseif($header->id == 6){
                                    $show_section = "#feature_categories";
                                }elseif($header->id == 7){
                                    $show_section = "#myTabContent10";
                                }elseif($header->id == 8){
                                    $show_section = "#cta_banner_section";
                                }elseif($header->id == 9){
                                    $show_section = "#amzcart_tabs_section";
                                }elseif($header->id == 10){
                                    $show_section = "#discount_banner";
                                }elseif($header->id == 11){
                                    $show_section = "#amaz_recomanded_area";
                                }
                            
                            @endphp
                            <iframe id="myFrame" src="{{url('/') . $show_section}}" frameborder="0" scrolling="no"></iframe>
                        </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-7">
                        <div id="item_div">
                            ...
                            @include('appearance::header.components.element_list_2',['id' => $header->id])
    ...
    (function($){
            ...
            $(document).ready(function() {
                ...
                $(document).on('submit', '#add_element_form', function(event) {
                    ...
                    if(header_type =='slider'){
                        ...
                        if(slider_image && name != '' && data_type != null){
                            ...
                            $.ajax({
                                url: "{{ route('appearance.header.setup.add-element_2') }}",
                                type: "POST",
                                cache: false,
                                contentType: false,
                                processData: false,
                ...
                $(document).on('submit', '#element_edit_form', function(event) {
                    ...
                    formData.append('_token', "{{ csrf_token() }}");
                    $.ajax({
                        url: "{{ route('appearance.header.setup.update-element_2') }}",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                $(document).on('submit', '#category_delete_form', function(event){
                    ...
                    $.post("{{ route('appearance.header.setup.delete-element_2') }}",data, function(data){
