...
Route::middleware(['auth','admin'])->prefix('appearance')->as('appearance.')->group(function() {
    ...
    //Slider 2
    Route::get('/headers/setup_2/{id}','HeaderController@setup_2')->name('header.setup_2')->middleware('permission');
    Route::post('/headers/setup/add-element_2','HeaderController@addElement_2')->name('header.setup.add-element_2')->middleware('prohibited_demo_mode');
    Route::post('/headers/setup/update-element_2','HeaderController@updateElement_2')->name('header.setup.update-element_2')->middleware('prohibited_demo_mode');
    Route::post('/headers/setup/delete-element_2','HeaderController@deleteElement_2')->name('header.setup.delete-element_2')->middleware('prohibited_demo_mode');
