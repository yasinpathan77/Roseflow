...
use Modules\Appearance\Entities\HeaderSliderPanel2;
...
class HeaderRepository {
    ...
    public function getByIn($ids){
        return Header::whereIn('id', $ids)->get();
    }
    ...
    public function updateElement_2($data){
        ...
        elseif($header->type == 'slider'){
            $slider = HeaderSliderPanel2::findOrFail($data['id']);
