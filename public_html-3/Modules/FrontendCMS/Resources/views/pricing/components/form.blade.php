    ...
    <div class="white-box">
        <div class="add-visitor">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="primary_input mb-25">
                       <label class="primary_input_label" for="other_features">{{__('frontendCms.other_features')}}</label>
                        <textarea class="primary_input_field" id="other_features" name="other_features" autocomplete="off" rows="6" cols="35" placeholder="{{__('frontendCms.other_features')}}" style="height: auto;"></textarea>
                    </div>
                </div>
                <!-- End 014-add -->
